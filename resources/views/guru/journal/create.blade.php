...
<div class="container">
    ...
    <form action="{{ route('guru.journal.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="time" name="jam_start" id="jam_start" class="form-control @error('jam_start') is-invalid @enderror" value="{{ old('jam_start') }}" required>
            @error('jam_start')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="time" name="jam_end" id="jam_end" class="form-control @error('jam_end') is-invalid @enderror" value="{{ old('jam_end') }}" required>
            @error('jam_end')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
